namespace __NAME__.tests.infrastructure.containers.custom
{
    using System;
    using bdddoc.core;
    ...
    using Rhino.Mocks;
    using __NAME__.infrastructure.containers;
    using __NAME__.infrastructure.logging;
    using __NAME__.infrastructure.logging.custom;
    using WindsorContainer=__NAME__.infrastructure.containers.custom.WindsorContainer;
