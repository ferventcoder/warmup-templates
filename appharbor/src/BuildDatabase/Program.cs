namespace BuildDatabase
{
    ...
    using System.Text;
    using __NAME__.orm.conventions;
    using __NAME__.orm.mappings;
    using NHibernate;
    ...
    internal class Program
    {
        ...
        private static void build_database_schema(string db_server, string db_name)
        {
            ...
            ISessionFactory sf = NHibernateSessionFactory.build_session_factory<SampleItemMapping, PrimaryKeyConvention>(db_server, db_name, build_schema);
        }
        ...
        {
            ISessionFactory sf = NHibernateSessionFactory.build_session_factory<SampleItemMapping, PrimaryKeyConvention>(db_server, db_name, update_schema);
        }
