namespace BuildDatabase
{
    ...
    internal class Program
    {
        ...
        private static void build_database_schema(string db_server, string db_name)
        {
            ...
            ISessionFactory sf = NHibernateSessionFactory.build_session_factory<SampleItemMap, PrimaryKeyConvention>(db_server, db_name, build_schema);
        }
        ...
        {
            ISessionFactory sf = NHibernateSessionFactory.build_session_factory<SampleItemMap, PrimaryKeyConvention>(db_server, db_name, update_schema);
        }
