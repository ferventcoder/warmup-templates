namespace __NAME__.infrastructure.persistence.custom
{
    using System;
    ...
    public sealed class NHibernateRepository : IRepository
    {
        ...
        public NHibernateRepository(ISessionFactory session_factory)
        {
        ...
        public IList<T> get_with_criteria<T>(DetachedCriteria detachedCriteria)
        {
            ...
            Log.bound_to(this).log_an_info_event_containing("Repository found {0} records of type {1} with criteria {2}.", list.Count, typeof(T).Name,
                                                            detachedCriteria.ToString());
